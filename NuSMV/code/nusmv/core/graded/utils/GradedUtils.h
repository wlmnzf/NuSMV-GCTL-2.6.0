...
DdNode * GradedUtils_addApplyRecur(DdManager *, ptruint, DdNode *, DdNode *, DdNode * );

DdNode * GradedUtils_addApply(DdManager *, ptruint, DdNode *, DdNode *, int);

DdNode * GradedUtils_addAbstract(DDMgr_ptr, add_ptr, bdd_ptr, int);

DdNode * GradedUtils_addAbstractRecur(DdManager *, ptruint, DdNode *, DdNode *, DdNode *);

DdNode * GradedUtils_AddAndAbstract(DdManager *,  DdNode *, DdNode *, DdNode *, int);
