...
typedef bdd_ptr (*Operator1NG)(DDMgr_ptr, bdd_ptr);
typedef bdd_ptr (*Operator1G)(DDMgr_ptr, bdd_ptr, int);
typedef bdd_ptr (*Operator1NGM)(BddFsm_ptr, bdd_ptr);
typedef bdd_ptr (*Operator1GM)(BddFsm_ptr, bdd_ptr, int);
typedef bdd_ptr (*Operator2NG)(DDMgr_ptr, bdd_ptr, bdd_ptr);
typedef bdd_ptr (*Operator2G)(DDMgr_ptr, bdd_ptr, bdd_ptr, int);
typedef bdd_ptr (*Operator2NGM)(BddFsm_ptr, bdd_ptr, bdd_ptr);
typedef bdd_ptr (*Operator2GM)(BddFsm_ptr, bdd_ptr, bdd_ptr, int);
typedef bdd_ptr (*Operator3NG)(DDMgr_ptr, bdd_ptr, int, int);
typedef bdd_ptr (*Operator3G)(DDMgr_ptr, bdd_ptr, int, int, int);
typedef bdd_ptr (*Operator3NGM)(BddFsm_ptr, bdd_ptr, int, int);
typedef bdd_ptr (*Operator3GM)(BddFsm_ptr, bdd_ptr, int, int, int);
typedef bdd_ptr (*Operator4NG)(DDMgr_ptr, bdd_ptr, bdd_ptr, int, int, int);
typedef bdd_ptr (*Operator4G)(DDMgr_ptr, bdd_ptr, bdd_ptr, int, int, int, int);
...
/*---------------------------------------------------------------------------*/
static bdd_ptr evalRecur(BddFsm_ptr, BddEnc_ptr enc, node_ptr, node_ptr);

static bdd_ptr operation1NG(BddFsm_ptr, BddEnc_ptr, Operator1NG, node_ptr, int, int, node_ptr);

static bdd_ptr operation1NGM(BddFsm_ptr, BddEnc_ptr, Operator1NGM, node_ptr, int, int, node_ptr);

static bdd_ptr operation2NG(BddFsm_ptr, BddEnc_ptr, Operator2NG, node_ptr, int, int, int, node_ptr);

static bdd_ptr operation2NGM(BddFsm_ptr, BddEnc_ptr, Operator2NGM, node_ptr, int, int, int, node_ptr);

static bdd_ptr operation1G(BddFsm_ptr, BddEnc_ptr, Operator1G, node_ptr, int, int, node_ptr);

static bdd_ptr operation1GM(BddFsm_ptr, BddEnc_ptr, Operator1GM, node_ptr, int, int, node_ptr);

static bdd_ptr operation2G(BddFsm_ptr, BddEnc_ptr, Operator2G, node_ptr, int, int, int, node_ptr);

static bdd_ptr operation2GM(BddFsm_ptr, BddEnc_ptr, Operator2GM, node_ptr, int, int, int, node_ptr);
...
//    DDMgr_ptr dd = BddEnc_get_dd_manager(enc);
    ...
    switch (node_get_type(n)) {
        ...
        default: {
            ...
            if (res_bdd == NULL) {
                ErrorMgr_rpterr(errmgr,"evalGradedCtlSpec: res = NULL after a call to \"eval\".");
...
//    set_the_node(n);
    ErrorMgr_set_the_node(errmgr, n); /* set node for error reporting */
